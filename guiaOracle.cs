using System;
using System.Data;
using Oracle.ManagedDataAccess.Client; // Requiere el paquete NuGet Oracle.ManagedDataAccess
using System.Windows.Forms;

namespace testDBOracle
{
    public partial class Form1 : Form
    {
        // Cadena de conexión para la base de datos Oracle
        string connStr = "User Id=usertestdb;Password=ajedrez1;Data Source=192.168.1.14:1521/xe";
        ...
        // Método para probar la conexión con la base de datos Oracle
        ...
        // Actualiza un usuario en la base de datos Oracle
            ...
            try
            {
                using (OracleConnection connection = new OracleConnection(connStr))
                {
                    ...
                    using (OracleCommand command = new OracleCommand(query, connection))
                    {
                        ...
                        command.Parameters.Add(new OracleParameter("nombre", nuevoNombre));
                        command.Parameters.Add(new OracleParameter("apellido", nuevoApellido));
        ...
        // Inserta un nuevo usuario en la base de datos Oracle
            ...
            try
            {
                using (OracleConnection connection = new OracleConnection(connStr))
                {
                    ...
                    using (OracleCommand command = new OracleCommand(query, connection))
                    {
                        ...
                        command.Parameters.Add(new OracleParameter("apellido", apellido));
                        command.Parameters.Add(new OracleParameter("correo", email));
                        command.Parameters.Add(new OracleParameter("telefono", telefono));
                        command.Parameters.Add(new OracleParameter("fecha", fechaRegistro));
